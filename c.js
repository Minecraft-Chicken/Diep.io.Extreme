(function () {
    ...
    window.onerror = function (message, source, lineno, colno, error) {
        ...
        if (source != null && source.indexOf("diep.io") == -1)
            return;
        if (source != null && source != "http://diep.io/d.js" && source != "https://diep.io/d.js")
            return;
        ...
        var e = JSON.stringify({ message: message, source: source, lineno: lineno, colno: colno, error: error });
